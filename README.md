...
## Parameters
    ...
    eedi3metal.EEDI3(clip clip, int field[, bint dh=False, int[] planes=[0, 1, 2], float alpha=0.2, float beta=0.25, float gamma=20.0, int nrad=2, int mdis=20, bint hp=False, bint ucubic=True, bint cost3=True, int vcheck=2, float vthresh0=32.0, float vthresh1=64.0, float vthresh2=4.0, clip sclip=None, clip mclip=None])
...
| :---------------- | :--- | :--------------- | :------------------------ | :---------------- |
| **Inner Loop**    | $A$  | **0.00041**      | **0.00160**               | **3.90x**         |
| **Outer Loop**    | $B$  | **0.00115**      | **0.00404**               | **3.51x**         |
| **Base Overhead** | $C$  | -0.00745         | +0.017                    | N/A               |
